(function(){
  ...
  // ── Inyectar CSS ────────────────────────────────────────────────────────────
  var css = [
    '#subs-widget{margin:16px 0}',
    '#subs-widget *{box-sizing:border-box}',
    '#subs-widget .subs-tabs{display:grid;grid-template-columns:1fr 1fr;border:1px solid rgba(var(--color-foreground),.15);border-radius:var(--buttons-radius,4px);overflow:hidden;margin-bottom:12px}',
    '#subs-widget .subs-tab{padding:11px 8px;font-size:13px;font-weight:600;font-family:inherit;cursor:pointer;border:none;background:transparent;color:inherit;opacity:.45;transition:background .2s,opacity .2s;text-align:center;line-height:1.3}',
    '#subs-widget .subs-tab:first-child{border-right:1px solid rgba(var(--color-foreground),.15)}',
    '#subs-widget .subs-tab.active{background:rgba(var(--color-foreground),.06);opacity:1}',
    '#subs-widget .subs-tab-badge{display:inline-block;font-size:10px;font-weight:700;background:rgb(var(--color-foreground));color:rgb(var(--color-background));padding:1px 6px;border-radius:20px;margin-left:5px;vertical-align:middle;letter-spacing:.02em}',
    '#subs-widget .subs-panel{display:none}',
    ...
    '#subs-widget .subs-precio-original{font-size:13px;text-decoration:line-through;opacity:.4}',
    '#subs-widget .subs-precio-final{font-size:17px;font-weight:700}',
    '#subs-widget .subs-ahorro-badge{font-size:11px;font-weight:700;background:#e8f5e9;color:#2e7d32;padding:2px 8px;border-radius:20px}',
    '#subs-widget .subs-freq-title{font-size:12px;font-weight:600;opacity:.7;margin-bottom:8px}',
    '#subs-widget .subs-chips{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:10px}',
    '#subs-widget .subs-chip{display:inline-flex;align-items:center;gap:4px;font-size:11px;font-weight:500;padding:4px 10px;border-radius:20px;border:1px solid rgba(var(--color-foreground),.15);opacity:.75}',
