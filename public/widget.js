(function(){
  ...
  // ── Inyectar CSS ────────────────────────────────────────────────────────────
  var css = [
    '#subs-widget{margin:16px 0;padding:16px;border:1.5px solid rgba(var(--color-foreground),.12);border-radius:var(--buttons-radius,8px);background:rgba(var(--color-foreground),.02)}',
    '#subs-widget *{box-sizing:border-box}',
    '#subs-widget .subs-tabs{display:grid;grid-template-columns:1fr 1fr;border:1.5px solid rgba(var(--color-foreground),.18);border-radius:var(--buttons-radius,6px);overflow:hidden;margin-bottom:14px}',
    '#subs-widget .subs-tab{padding:12px 8px;font-size:13px;font-weight:600;font-family:inherit;cursor:pointer;border:none;background:transparent;color:inherit;opacity:.5;transition:background .2s,opacity .2s,box-shadow .2s;text-align:center;line-height:1.3}',
    '#subs-widget .subs-tab:first-child{border-right:1.5px solid rgba(var(--color-foreground),.18)}',
    '#subs-widget .subs-tab.active{background:rgba(var(--color-foreground),.08);opacity:1;box-shadow:inset 0 -2px 0 rgb(var(--color-foreground))}',
    '#subs-widget .subs-tab:hover:not(.active){opacity:.7;background:rgba(var(--color-foreground),.03)}',
    '#subs-widget .subs-tab-badge{display:inline-block;font-size:10px;font-weight:700;background:rgb(var(--color-foreground));color:rgb(var(--color-background));padding:2px 8px;border-radius:20px;margin-left:5px;vertical-align:middle;letter-spacing:.02em}',
    ...
    '#subs-widget .subs-precio-original{font-size:13px;text-decoration:line-through;opacity:.45}',
    '#subs-widget .subs-precio-final{font-size:18px;font-weight:700}',
